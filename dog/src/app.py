...
# Read in data
traits_raw_df = pd.read_csv("/home/nzangi/PycharmProjects/My Projects/dog/data/breed_traits.csv")
breed_rank_raw_df = pd.read_csv("/home/nzangi/PycharmProjects/My Projects/dog/data/breed_rank.csv")
